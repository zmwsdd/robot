//
//  SwifBaseViewController.swift
//  niaoyutong
//
//  Created by zhangmingwei on 2017/5/4.
...
class SwifBaseViewController: UIViewController {

    // 添加单利后其他的页面才可以调用本文件，并且新建文件的时候可以继承本文件！！！！！！
    static let shared = SwifBaseViewController() // 跟视图的单利

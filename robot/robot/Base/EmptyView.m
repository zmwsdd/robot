...
//        _lastLabel.font = FONT_Helvetica(12);
...
#pragma mark - 三行的情况下
//- (void)imageString:(NSString *)imageString labelString:(NSString *)labelString lastString:(NSString *) lastString {
//    UIImage *image = [UIImage imageNamed:imageString];
//    
//    self.imageV.image = image;
//    self.label.text = labelString;
//    self.lastLabel.text = lastString;
//    self.label.textColor = [UIColor colorFromHexString:@"#979797"];
//    self.lastLabel.textColor = [UIColor colorFromHexString:@"#979797"];
//
//    [self.imageV

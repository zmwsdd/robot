...
//  ZMWJokeOC
//
//  Created by zhangmingwei on 2017/3/8.
//  Copyright © 2017年 speedx. All rights reserved.
//  暂时不支持model嵌套model的情况，如果有的话，可以暂时用文本直接存储json返回的数组
...
// 默认数据库名
#define FLDB_DEFAULT_NAME @"fmdbNiaoYuTong"

// 数据库manager
#define kFLFMDBQueueManager [FLFMDBQueueManager shareManager:FLDB_DEFAULT_NAME]
